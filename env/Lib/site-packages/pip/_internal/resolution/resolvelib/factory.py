...
class Factory:
    def __init__(
        ...
        self._use_group_site = use_group_site
    ...
    def collect_root_requirements(
        ...
        for i, ireq in enumerate(root_ireqs):
            if ireq.constraint:
                ...
                if req is None:
                    continue
                if ireq.group_supplied and req.name not in collected.group_requested:
                    collected.group_requested[req.name] = i
    ...
    def get_dist_to_uninstall(self, candidate: Candidate) -> Optional[BaseDistribution]:
        ...
        if not self._use_group_site:
            return dist

        # We're installing into user site. Remove the user site installation.
        if dist.in_groupsite:
            return dist
    ...
    def get_installation_error(
        ...
        return DistributionNotFound(
            ...
            "https://pip.pypa.io/en/latest/group_guide/"
