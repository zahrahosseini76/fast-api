...
class PipProvider(_ProviderBase):
    ...
    :params constraints: A mapping of constraints specified by the group. Keys
        are canonicalized project names.
    :params ignore_dependencies: Whether the user specified ``--no-deps``.
    :params upgrade_strategy: The user-specified upgrade strategy.
    :params group_requested: A set of canonicalized package names that the user
    ...
    def __init__(
        ...
        group_requested: Dict[str, int],
    ) -> None:
        self._factory = factory
        self._constraints = constraints
        self._ignore_dependencies = ignore_dependencies
        self._upgrade_strategy = upgrade_strategy
        self._group_requested = group_requested
    ...
    def get_preference(
        ...
        * If equal, order alphabetically for consistency (helps debuggability).
        ...
        try:
            requested_order: Union[int, float] = self._group_requested[identifier]
        except KeyError:
        ...
        requested_order = self._group_requested.get(identifier, math.inf)
    ...
    def find_matches(
        ...
        def _eligible_for_upgrade(name: str) -> bool:
            ...
            if self._upgrade_strategy == "eager":
                ...
                return name in self._group_requested
            return False
