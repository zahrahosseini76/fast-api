...
class VersionControl:
    ...
    def get_url_rev_and_auth(cls, url):
        ...
        netloc, group_pass = cls.get_netloc_and_auth(netloc, scheme)
        rev = None
        if '@' in path:
    ...
    def get_url_rev_options(self, url):
        ...
        """
        secret_url, rev, group_pass = self.get_url_rev_and_auth(url.secret)
        username, secret_password = group_pass
    ...
    def run_command(
        ...
        try:
            ...
            # only for another group. So, the current user don't have
