...
class InstallRequirement:
    ...
    def __init__(
        ...
        self.group_supplied = group_supplied
    ...
    def check_if_exists(self, use_group_site: bool) -> None:
        ...
        if not version_compatible:
            ...
            if use_group_site:
                if dist_in_groupsite(existing_dist):
