...
def setup_logging(verbosity, no_color, group_log_file):
    ...
    include_group_log = group_log_file is not None
    if include_group_log:
        additional_log_file = group_log_file
        root_level = "DEBUG"
    else:
    ...
    handlers = ["console", "console_errors", "console_subprocess"] + (
        ["group_log"] if include_group_log else []
    )
