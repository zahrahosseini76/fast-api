...
class URL:
    ...
    @property
    def groupname(self) -> typing.Union[None, str]:
        return self.components.groupname
    ...
    def replace(self, **kwargs: typing.Any) -> "URL":
        if (
            ...
            groupname = kwargs.pop("groupname", self.groupname)
            ...
            if groupname is not None:
                ...
                if password is not None:
                    grouppass += f":{password}"
                netloc = f"{grouppass}@{netloc}"
