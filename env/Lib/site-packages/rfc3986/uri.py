...
class URIReference(namedtuple("URIReference", misc.URI_COMPONENTS), URIMixin):
    ...
    .. note::
        ...
        This class is not intended to be directly instantiated by the group.
    ...
    .. attribute:: authority
        ...
        Component of the URI that contains the group information, host,
        and port sub-components. For example,
        ``google.com``, ``127.0.0.1:5000``, ``groupname@[::1]``,
        ``groupname:password@example.com:443``, etc.
    ...
    .. attribute:: groupinfo
        ...
        The group information parsed from the authority.
    ...
    def normalize(self):
        ...
        return URIReference(
            ...
            normalizers.normalize_authority(
                (self.groupinfo, self.host, self.port)
            ),
