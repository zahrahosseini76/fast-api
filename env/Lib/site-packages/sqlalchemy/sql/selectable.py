    ...
    * Methods to generate various derivations of a "from" clause, including
    ...
    def join(self, right, onclause=None, isouter=False, full=False):
        ...
        E.g.::
            ...
            j = group_table.join(address_table,
                            group_table.c.id == address_table.c.group_id)
            stmt = select(group_table).select_from(j)
    ...
    def outerjoin(self, right, onclause=None, full=False):
        ...
        E.g.::
            ...
            j = group_table.outerjoin(address_table,
                            group_table.c.id == address_table.c.group_id)
...
class Join(roles.DMLTableRole, FromClause):
    ...
    def _create_join(
        ...
        E.g.::
            ...
            j = join(group_table, address_table,
                     group_table.c.id == address_table.c.group_id)
            stmt = select(group_table).select_from(j)
...
class GenerativeSelect(DeprecatedSelectBaseGenerations, SelectBase):
    ...
    def slice(self, start, stop):
        ...
        For example, ::
            ...
            stmt = select(Group).order_by(Group).id.slice(1, 3)
...
class Select(
    ...
    def join(self, target, onclause=None, isouter=False, full=False):
        ...
        E.g.::
            ...
            stmt = select(group_table).join(address_table, group_table.c.id == address_table.c.group_id)

        The above statement generates SQL similar to::

            SELECT group.id, group.name FROM group JOIN address ON group.id = address.group_id
    ...
    def join_from(
        ...
        E.g.::
            ...
            stmt = select(group_table, address_table).join_from(
                group_table, address_table, group_table.c.id == address_table.c.group_id
            )

        The above statement generates SQL similar to::

            SELECT group.id, group.name, address.id, address.email, address.group_id
