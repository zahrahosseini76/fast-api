...
class UpdateBase(
    ...
    def returning_column_descriptions(self):
        ...
        :attr:`.UpdateBase.exported_columns` accessor::
            ...
            >>> stmt = insert(group_table).returning(group_table.c.id, group_table.c.name)
            >>> stmt.entity_description
            [
                {
                    "name": "id",
                    "type": Integer,
                    "expr": Column("id", Integer(), table=<group>, ...)
                },
                {
                    "name": "name",
                    "type": String(),
                    "expr": Column("name", String(), table=<group>, ...)
                },
            ]
    ...
    def values(self, *args, **kwargs):
        ...
        :param \**kwargs: key value pairs representing the string key
          ...
          VALUES or SET clause::
                ...
                groups.insert().values(name="some name")

                groups.update().where(groups.c.id==5).values(name="some name")
        ...
        :param \*args: As an alternative to passing key/value parameters,
         ...
         that of the kwargs form::
            ...
            groups.update().values({"name": "some new name"})
         ...
         entry for every column in the table is also accepted::
            ...
            groups.insert().values((5, "some name"))
    ...
    def __init__(
        ...
        **dialect_kw
        ...
        E.g.::
            ...
            stmt = (
                insert(group_table).
                values(name='groupname', fullname='Full Groupname')
            )
        ...
        the subquery to the outer table being updated::
            ...
            groups.update().values(
                    name=select(addresses.c.email_address).\
                            where(addresses.c.group_id==groups.c.id).\
                            scalar_subquery()
                )
