...
class GenericFunction(util.with_metaclass(_GenericMeta, Function)):
    ...
    example, a group-defined function ``as_utc()`` would
    ...
    Group-defined generic functions can be organized into
...
class current_group(AnsiFunction):
...
class session_group(AnsiFunction):
