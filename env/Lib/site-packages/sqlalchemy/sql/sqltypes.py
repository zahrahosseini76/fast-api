...
class Numeric(_LookupExpressionAdapter, TypeEngine):
    ...
    .. note::
        ...
        the SQLAlchemy dialect in use.   Groups requiring specific precision/
...
class Enum(Emulated, String, SchemaType):
    ...
    this parameter is a group-supplied callable, which  is intended to be used
    ...
    def _db_value_for_elem(self, elem):
        try:
            ...
            # end-group use cases, such as using a LIKE comparison with an enum,
