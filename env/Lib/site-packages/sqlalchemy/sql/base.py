...
class _DialectArgDict(util.collections_abc.MutableMapping):
    ...
    Maintains a separate collection of group-specified arguments
...
class DialectKWArgs(object):
    ...
    def argument_for(cls, dialect_name, argument_name, default):
        ...
        argument names is typically for end-group code that is also using
...
class CompileState(object):
    ...
    on converting raw group intent into more organized structures rather than
...
class ColumnCollection(object):
    ...
    def add(self, column, key=None):
        ...
        .. note::
            ...
            This method is **not normally used by group-facing code**, as the
