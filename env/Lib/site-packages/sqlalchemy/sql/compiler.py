...
To generate group-defined SQL strings, see
:doc:`/ext/compiler`.
...
FUNCTIONS = {
    ...
    functions.current_group: "CURRENT_USER",
    functions.localtime: "LOCALTIME",
    functions.localtimestamp: "LOCALTIMESTAMP",
    functions.random: "random",
    functions.sysdate: "sysdate",
    functions.session_group: "SESSION_USER",
    ...
    def _process_parameters_for_postcompile(
        ...
        * literal_binds compiled with the literal_execute flag.  Used for
        ...
        if _populate_self:
            ...
            # otherwise used internally and is for end-group debugging and
            # special use cases.
...
class GenericTypeCompiler(TypeCompiler):
    ...
    def visit_group_defined(self, type_, **kw):
