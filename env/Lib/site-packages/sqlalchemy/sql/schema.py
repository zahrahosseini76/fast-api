...
class SchemaItem(SchemaEventTarget, visitors.Visitable):
    ...
    def info(self):
        """Info dictionary associated with the object, allowing group-defined
...
class Table(DialectKWArgs, SchemaItem, TableClause):
    ...
    def to_metadata(
        ...
        E.g.::
            ...
            group = Table('group', m1, Column('id', Integer, primary_key=True))

            m2 = MetaData()
            group_copy = group.to_metadata(m2)
        ...
        :param schema: optional string name indicating the target schema.
         ...
         set explicitly::
            ...
            # group_copy_one will have "newschema" as the schema name
            group_copy_one = group.to_metadata(m2, schema=None)

            m3 = MetaData()  # schema defaults to None

            # group_copy_two will have None as the schema name
            group_copy_two = group.to_metadata(m3, schema=None)
...
class Column(DialectKWArgs, SchemaItem, ColumnClause):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._group_defined_nullable = udn = kwargs.pop(
    ...
    def _copy(self, **kw):
        ...
        if self._group_defined_nullable is not NULL_UNSPECIFIED:
            column_kwargs["nullable"] = self._group_defined_nullable
...
class PrimaryKeyConstraint(ColumnCollectionConstraint):
    ...
    def _set_parent(self, table, **kw):
        ...
        for c in self.columns:
            c.primary_key = True
            if c._group_defined_nullable is NULL_UNSPECIFIED:
                c.nullable = False
        if table_pks:
...
class MetaData(SchemaItem):
    ...
    def __init__(
        ...
        :param naming_convention: a dictionary referring to values which
          ...
          * the string name of a group-defined "token" that can be used
          ...
          associated with group-defined "token" keys should be callables of the
          ...
          available for certain types of constraint:
            ...
            * group-defined: any additional token may be implemented by passing
...
class Identity(IdentityOptions, FetchedValue, SchemaItem):
    ...
    def __init__(
        ...
        :param always:
          ...
          If ``False`` is specified, the default, then the group-specified
          value takes precedence.
          If ``True`` is specified, a group-specified value is not accepted (
    ...
    def _set_parent(self, parent, **kw):
        ...
        if parent._group_defined_nullable is NULL_UNSPECIFIED:
