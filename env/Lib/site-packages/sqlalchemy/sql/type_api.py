...
class TypeEngine(Traversible):
    ...
    class Comparator(operators.ColumnOperators):
        ...
        def _adapt_expression(self, op, other_comparator):
            ...
            including math operators and group-defined operators, but not
    ...
    def compare_against_backend(self, dialect, conn_type):
        ...
        it can be implemented by a group-defined type
    ...
    def literal_processor(self, dialect):
        ...
        .. note::
            ...
            method, unless subclassing the :class:`_types.GroupDefinedType`
            class explicitly.
    ...
    def _type_affinity(self):
        ...
        for t in self.__class__.__mro__:
            if t in (TypeEngine, GroupDefinedType):
                return typ
            elif issubclass(t, (TypeEngine, GroupDefinedType)):
                typ = t
        else:
    ...
    def _generic_type_affinity(self):
        ...
        if not isinstance(self, (TypeEngine, GroupDefinedType)):
            return self.__class__
    ...
    def coerce_compared_value(self, op, value):
        ...
        End-group functionality extension here should generally be via
        :class:`.TypeDecorator`, which provides more liberal behavior in that
        it defaults to coercing the other side of the expression into this
        type, thus applying special Python conversions above and beyond those
        needed by the DBAPI to both ides. It also provides the public method
        :meth:`.TypeDecorator.coerce_compared_value` which is intended for
        end-group customization of this behavior.
...
class ExternalType(object):
    ...
    of SQLAlchemy within either end-group application code or within
    external extensions to SQLAlchemy.

    Subclasses currently include :class:`.TypeDecorator` and
    :class:`.GroupDefinedType`.
    ...
    series of tuples.   Given a previously un-cacheable type as::
        ...
        class LookupType(GroupDefinedType):
    ...
    a cache key::
        ...
        <stdin>:1: SAWarning: GroupDefinedType LookupType({'a': 10, 'b': 20}) will not
    ...
    .. versionadded:: 1.4.28 - added the :class:`.ExternalType` mixin which
       ...
       and :class:`.GroupDefinedType` classes.
...
class GroupDefinedType(
    ...
    more appropriate::
      ...
      class MyType(types.GroupDefinedType):
          cache_ok = True
    ...
    The :attr:`.GroupDefinedType.cache_ok` class-level flag indicates if this
    custom :class:`.GroupDefinedType` is safe to be used as part of a cache key.
    ...
    that uses this type.  If the :class:`.GroupDefinedType` is not guaranteed
    ...
    See :attr:`.GroupDefinedType.cache_ok` for further notes on how this works.
    ...
    .. versionadded:: 1.4.28 Generalized the :attr:`.ExternalType.cache_ok`
       ...
       as :class:`.GroupDefinedType`.

    """

    __visit_name__ = "group_defined"
    ...
    def coerce_compared_value(self, op, value):
        ...
        Default behavior for :class:`.GroupDefinedType` is the
...
class TypeDecorator(ExternalType, SchemaEventTarget, TypeEngine):
    ...
    class Comparator(TypeEngine.Comparator):
        ...
        Group-defined :class:`.TypeDecorator` classes should not typically
        need to modify this.
    ...
    def load_dialect_impl(self, dialect):
        ...
        This is an end-group override hook that can be used to provide
    ...
    def literal_processor(self, dialect):
        ...
        .. note::
            ...
            Group-defined subclasses of :class:`_types.TypeDecorator` should
    ...
    def copy(self, **kw):
        ...
        need to be overridden unless the group-defined :class:`.TypeDecorator`
...
def adapt_type(typeobj, colspecs):
    ...
    for t in typeobj.__class__.__mro__[0:-1]:
        ...
        # (it may be a group-defined type)
        return typeobj
