...
class RelationshipProperty(StrategizedProperty):
    ...
    def __init__(
        ...
        :param uselist:
          ...
          with collections or scalar attributes::
              ...
              >>> Group.addresses.property.uselist
              True
        ...
        self._group_defined_foreign_keys = foreign_keys
    ...
    def _get_attr_w_warn_on_none(self, mapper, state, dict_, column):
        ...
        E.g.::
            ...
            u1 = s.query(Group).get(5)

            expr = Address.group == u1

        Above, the SQL should be "address.group_id = 5". The callable
        ...
        #
        # * the object hasn't been flushed yet but it has a group-defined
        #   value
        #
        ...
        #
        # * the object has a group-set value, but it's None and we don't do
    ...
    def _process_dependent_arguments(self):
        ...
        self._group_defined_foreign_keys = util.column_set(
            coercions.expect(
                roles.ColumnArgumentRole, x, argname="foreign_keys"
            )
            for x in util.to_column_set(self._group_defined_foreign_keys)
        )
    ...
    def _setup_join_conditions(self):
        self._join_condition = jc = JoinCondition(
            ...
            consider_as_foreign_keys=self._group_defined_foreign_keys,
    ...
    def _generate_backref(self):
        ...
        if self.backref is not None and not self.back_populates:
            ...
            foreign_keys = kwargs.pop(
                "foreign_keys", self._group_defined_foreign_keys
            )
...
class JoinCondition(object):
    ...
    def _annotate_local(self):
        ...
        _annotate_remote() or group-defined.
