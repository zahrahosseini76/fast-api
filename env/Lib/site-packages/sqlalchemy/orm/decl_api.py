...
class declared_attr(interfaces._MappedAttribute, property):
    ...
    both::
        ...
        class ProvidesGroup(object):
            "A mixin that adds a 'group' relationship to classes."

            @declared_attr
            def group_id(self):
                return Column(ForeignKey("group_account.id"))
    ...
    it may be placed directly inside the field metadata using a lambda::
        ...
        class AddressMixin:
            ...
            group_id: int = field(
                init=False, metadata={"sa": declared_attr(lambda: Column(ForeignKey("group.id")))}
            )
            group: Group = field(
                init=False, metadata={"sa": declared_attr(lambda: relationship(Group))}
            )
    ...
    lambda directly, as in::
        ...
        group: Group = field(
            init=False, metadata={"sa": lambda: relationship(Group)}
        )
