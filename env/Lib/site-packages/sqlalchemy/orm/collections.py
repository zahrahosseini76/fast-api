...
class collection(object):
    ...
    def converter(fn):
        ...
        its sole job is to adapt the value the group provides into an iterable
...
class CollectionAdapter(object):
    ...
    def _set_empty(self, group_data):
        assert (
            not self.empty
        ), "This collection adapter is already in the 'empty' state"
        self.empty = True
        self.owner_state._empty_collections[self._key] = group_data
...
# these built-in classes; if a group-defined class
