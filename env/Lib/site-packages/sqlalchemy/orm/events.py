...
class InstanceEvents(event.Events):
    ...
    * the :class:`_orm.Mapper` class itself and the :func:`.mapper`
    ...
    def init(self, target, args, kwargs):
        ...
        This method is only called during a groupland construction of
...
class MapperEvents(event.Events):
    ...
    * the :class:`_orm.Mapper` class itself and the :func:`.mapper`
    ...
    group is encouraged to evaluate the
    :meth:`.SessionEvents.before_flush` and
    :meth:`.SessionEvents.after_flush` methods as more
    flexible and group-friendly hooks in which to apply
    ...
    :param raw=False: When True, the "target" argument passed
       ...
       instance's :class:`.InstanceState` management
       object, rather than the mapped instance itself.
    :param retval=False: when True, the group-defined event function
...
class AttributeEvents(event.Events):
    ...
    illustrated using the :meth:`_orm.AttributeEvents.set` event::
        ...
        # setup listener on GroupContact.phone attribute, instructing
        # it to use the return value
        listen(GroupContact.phone, 'set', validate_phone, retval=True)
    ...
    :param raw=False: When True, the "target" argument to the
      ...
      object, rather than the mapped instance itself.
    :param retval=False: when True, the group-defined event
    ...
    def init_collection(self, target, collection, collection_adapter):
        ...
        E.g., given that ``Group.addresses`` is a relationship-based
