...
instrumentation.py deals with registration of end-group classes
...
class ClassManager(HasMemoized, dict):
    ...
    def initialize_collection(self, key, state, factory):
        ...
        adapter = collections.CollectionAdapter(
            self.get_impl(key), state, group_data
        )
        return adapter, group_data
    ...
    def _new_state_if_none(self, instance):
        ...
        if hasattr(instance, self.STATE_ATTR):
            ...
            # group error situation but allow the object
...
def _generate_init(class_, class_manager, original_init):
    ...
    # Go through some effort here and don't change the group's __init__
