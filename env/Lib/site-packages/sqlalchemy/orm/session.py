...
class ORMExecuteState(util.MemoizedSlots):
    ...
    @property
    def group_defined_options(self):
        """The sequence of :class:`.GroupDefinedOptions` that have been
...
class Session(_SessionClassMethods):
    ...
    def get_bind(
        ...
        a group-defined subclass of :class:`.Session` to provide any kind
