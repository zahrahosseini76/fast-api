...
def listen(target, identifier, fn, *args, **kw):
    ...
    :param bool insert: The default behavior for event handlers is to append
      the decorated group defined function to an internal list of registered
      event listeners upon discovery. If a group registers a function with
      ...
      certain group defined functions can run before others, such as when
