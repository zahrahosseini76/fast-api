...
class ConnectionEvents(event.Events):
    ...
    :param retval=False: Applies to the :meth:`.before_execute` and
      ...
      group-defined event function must have a return value, which
    ...
    def handle_error(self, exception_context):
        ...
        * Establishing or disabling whether a connection or the owning
        ...
        the SQLAlchemy-constructed exception into one that is group
        ...
        .. warning::  Because the
           ...
           **stack traces will be misleading** if the group-defined event
        ...
        .. versionchanged:: 1.0.0 The :meth:`.handle_error` event is
           ...
           ``skip_group_error_events`` execution option.   This is used
...
class DialectEvents(event.Events):
    ...
    def do_connect(self, dialect, conn_rec, cargs, cparams):
        ...
        dictionary that may also be mutated::
            ...
            e = create_engine("postgresql+psycopg2://group@host/dbname")
