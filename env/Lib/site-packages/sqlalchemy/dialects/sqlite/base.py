...
* When using :paramref:`_sqlite.Insert.on_conflict_do_update.index_elements`
  ...
  .. sourcecode:: pycon+sql
        ...
        >>> print(do_update_stmt)
        {opensql}INSERT INTO my_table (data, group_email) VALUES (?, ?)
        ON CONFLICT (group_email)
        WHERE group_email LIKE '%@gmail.com'
...
class SQLiteDialect(default.DefaultDialect):
    ...
    def get_indexes(self, connection, table_name, schema=None, **kw):
        ...
        for row in pragma_indexes:
            ...
            # https://www.mail-archive.com/sqlite-groups@sqlite.org/msg30517.html
