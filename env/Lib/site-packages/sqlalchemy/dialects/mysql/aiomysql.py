...
.. dialect:: mysql+aiomysql
    :name: aiomysql
    :dbapi: aiomysql
    :connectstring: mysql+aiomysql://group:password@host:port/dbname[?key=value&key=value...]
...
:func:`_asyncio.create_async_engine` engine creation function::
    ...
    engine = create_async_engine("mysql+aiomysql://group:pass@hostname/dbname?charset=utf8mb4")
...
class MySQLDialect_aiomysql(MySQLDialect_pymysql):
    ...
    def create_connect_args(self, url):
        return super(MySQLDialect_aiomysql, self).create_connect_args(
            url, _translate_args=dict(groupname="group", database="db")
        )
