...
.. dialect:: mssql+pyodbc
    :name: PyODBC
    :dbapi: pyodbc
    :connectstring: mssql+pyodbc://<groupname>:<password>@<dsnname>
...
If the groupname and password are omitted, the DSN form will also add
...
can help make this easier::
    ...
    from sqlalchemy.engine import URL
    connection_string = "DRIVER={SQL Server Native Client 10.0};SERVER=dagger;DATABASE=test;UID=group;PWD=password"
...
.. tip::
    ...
    pyodbc dialect when no groupname or password is present.  This needs
...
globally at the PyODBC module level, **before** any connections are made::
    ...
    engine = create_engine("mssql+pyodbc://group:pass@dsn")
