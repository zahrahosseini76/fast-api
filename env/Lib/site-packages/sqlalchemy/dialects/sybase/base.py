...
class SybaseDialect(default.DefaultDialect):
    ...
    def _get_default_schema_name(self, connection):
        return connection.scalar(
            text("SELECT group_name() as group_name").columns(groupname=Unicode)
        )
    ...
    def get_table_id(self, connection, table_name, schema=None, **kw):
        ...
        TABLEID_SQL = text(
            """
          SELECT o.id AS id
          FROM sysobjects o JOIN sysgroups u ON o.uid=u.uid
    ...
    def get_columns(self, connection, table_name, schema=None, **kw):
        ...
        COLUMN_SQL = text(
          ...
          FROM systypes t, syscolumns col LEFT OUTER JOIN syscomments com ON
              col.cdefault = com.id
          WHERE col.grouptype = t.grouptype
              AND col.id = :table_id
          ORDER BY col.colid
        """
        )
    ...
    def get_schema_names(self, connection, **kw):
        ...
        SCHEMA_SQL = text("SELECT u.name AS name FROM sysgroups u")
