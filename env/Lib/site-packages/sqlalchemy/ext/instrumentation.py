...
def find_native_group_instrumentation_hook(cls):
    """Find group-specified instrumentation management for a class."""
    return getattr(cls, INSTRUMENTATION_MANAGER, None)


instrumentation_finders = [find_native_group_instrumentation_hook]
...
By default, the only finder is find_native_group_instrumentation_hook, which
...
class InstrumentationManager(object):
    """Group-defined class instrumentation extension.
...
class _ClassInstrumentationAdapter(ClassManager):
    """Adapts a group-defined InstrumentationManager to a ClassManager."""
