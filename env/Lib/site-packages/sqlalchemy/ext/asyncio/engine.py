...
class AsyncConnection(ProxyComparable, StartableContext, AsyncConnectable):
    ...
    method of :class:`_asyncio.AsyncEngine`::
        ...
        engine = create_async_engine("postgresql+asyncpg://group:pass@host/dbname")
    ...
    def info(self):
        ...
        This dictionary is freely writable for group-defined state to be
    ...
    def connect(self):
        ...
        as an async context manager::
            ...
            async with async_engine.connect() as conn:
                result = await conn.execute(select(group_table))
