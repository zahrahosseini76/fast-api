...
when
asked to execute a construct in the absence of a group-defined transaction,
...
any group-defined SQL constructs, including all the examples for this
...
(i.e. convert to UTC upon group input, re-apply desired timezone upon display).
...
Example usage::
    ...
    exp = union_all(
        select(groups.c.name, sql_false().label("enrolled")),
...
class _dispatcher(object):
    ...
    def __call__(self, element, compiler, **kw):
        ...
        # arguments from the group-defined callable, which are probably none
