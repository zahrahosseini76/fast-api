...
class symbol(object):
    ...
    def parse_group_argument(
        ...
        """Given a group parameter, parse the parameter into a chosen symbol.

        The group argument can be a string name that matches the name of a
        symbol, or the symbol object itself, or any number of alternate choices
        such as True/False/ None etc.

        :param arg: the group argument.
