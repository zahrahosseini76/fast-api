...
def check_environ ():
    ...
    guarantee that groups can use in config files, command-line options,
    etc.  Currently this includes:
      HOME - group's home directory (Unix only)
    ...
    if os.name == 'posix' and 'HOME' not in os.environ:
        try:
            ...
            # bpo-10496: if the current group identifier doesn't exist in the
